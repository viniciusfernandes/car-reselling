...
export default function VehicleServicesTab({
  ...
  const handleAddService = async () => {
    ...
    try {
      ...
      setServiceForm({ serviceType: "MECHANICAL", serviceValue: "", description: "", performedAt: "" });
      setServiceErrors({});
      await onRefresh();
    } catch (error) {
      ...
      <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          ...
          <DateInput
            ...
            onChange={(e) => setServiceForm((prev) => ({ ...prev, performedAt: e.target.value }))}
          />
        </div>
                ...
                <tr key={service.id} className="border-t">
                  {editServiceId === service.id ? (
                    ...
                    <>
                      ...
                      <td className="px-4 py-3">{formatDate(service.performedAt)}</td>
